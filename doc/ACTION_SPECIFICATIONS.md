...
| `WITCH_SAVE` / `HEAL` |🧙‍♂️Cứu | Phù thủy | Đêm | Current wolf victim or allowed save target | Potion inventory and save timing are stateful | Single-use save potion | Prevents applicable death | Potion already used, invalid phase, unavailable victim |
